...
namespace Ginet.Logging
{
    ...
    public class ActionAppender : IAppender
    {
        ...
        public ActionAppender(Action<string> echo, string logger = "Ginet", string formatTemplate = "[%Date{0:G}] %Logger %Verbosity - %Message")
        {
        ...
        public IAppender this[string appender] => new ActionAppender(Echo, appender);
